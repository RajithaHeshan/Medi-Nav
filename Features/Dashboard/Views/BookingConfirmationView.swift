...
//        VStack {
//            Button {
//                showPayment = true // 🔴 Triggers navigation to PaymentView
//            } label: {
...
struct BookingConfirmationView: View {
            ...
            VStack(spacing: 0) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🔴 FIXED: Increased spacer to ensure content isn't hidden behind the taller footer
    ...
    private var bottomFooter: some View {
        ...
        .background(
            Color(uiColor: .systemGroupedBackground)
                // 🔴 FIXED: Background now stretches behind the Custom Tab Bar
...
//        CustomTabBar(selectedTab: .constant(.booking))
        // 🔴 FIXED: Added homePath argument to clear the Xcode Preview error!
                CustomTabBar(selectedTab: .constant(.booking), homePath: .constant(NavigationPath()))
    }
}
