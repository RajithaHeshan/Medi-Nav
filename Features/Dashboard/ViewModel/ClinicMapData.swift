...
class ClinicMapData {
    ...
    let nodes: [String: MapNode] = [
        ...
        // -- Vertical Hallway Left Side (🔴 NEW ROOMS ADDED HERE) --
        "xray_room": MapNode(id: "xray_room", name: "X-ray Room", position: CGPoint(x: 0.38, y: 0.24), connectedEdges: ["hall_xray"], isDestination: true),
        "exam_room_1": MapNode(id: "exam_room_1", name: "Exam Room 1", position: CGPoint(x: 0.38, y: 0.32), connectedEdges: ["hall_dr_1"], isDestination: true),
        "elevator": MapNode(id: "elevator", name: "Elevator", position: CGPoint(x: 0.40, y: 0.63), connectedEdges: ["hall_elevator"], isDestination: true),
        "patient_info": MapNode(id: "patient_info", name: "Patient Information & Records", position: CGPoint(x: 0.35, y: 0.73), connectedEdges: ["hall_pharmacy"], isDestination: true),
        
        // -- Vertical Hallway Right Side (🔴 NEW ROOMS ADDED HERE) --
        "dr_12": MapNode(id: "dr_12", name: "Doctor 12", position: CGPoint(x: 0.62, y: 0.24), connectedEdges: ["hall_xray"], isDestination: true),
        "dr_room_1": MapNode(id: "dr_room_1", name: "Doctor Room 1", position: CGPoint(x: 0.62, y: 0.32), connectedEdges: ["hall_dr_1"], isDestination: true),
        "dr_room_2": MapNode(id: "dr_room_2", name: "Doctor Room 2", position: CGPoint(x: 0.62, y: 0.42), connectedEdges: ["hall_dr_2"], isDestination: true),
        "lab_room": MapNode(id: "lab_room", name: "Laboratory Room", position: CGPoint(x: 0.62, y: 0.63), connectedEdges: ["hall_elevator"], isDestination: true),
        "pharmacy": MapNode(id: "pharmacy", name: "Pharmacy", position: CGPoint(x: 0.60, y: 0.73), connectedEdges: ["hall_pharmacy"], isDestination: true),
        ...
        // ==========================================
        // 🔴 INVISIBLE HALLWAY INTERSECTIONS
        // ==========================================
        ...
        // Main Vertical (Updated to support new rooms)
        "hall_cafeteria": MapNode(id: "hall_cafeteria", name: "Hallway", position: CGPoint(x: 0.50, y: 0.16), connectedEdges: ["clinic_cafeteria", "hall_xray"], isDestination: false),
        "hall_xray": MapNode(id: "hall_xray", name: "Hallway", position: CGPoint(x: 0.50, y: 0.24), connectedEdges: ["hall_cafeteria", "xray_room", "dr_12", "hall_dr_1"], isDestination: false),
        "hall_dr_1": MapNode(id: "hall_dr_1", name: "Hallway", position: CGPoint(x: 0.50, y: 0.32), connectedEdges: ["hall_xray", "exam_room_1", "dr_room_1", "hall_dr_2"], isDestination: false),
        "hall_dr_2": MapNode(id: "hall_dr_2", name: "Hallway", position: CGPoint(x: 0.50, y: 0.42), connectedEdges: ["hall_dr_1", "dr_room_2", "hall_middle_cross"], isDestination: false),
        
        "hall_middle_cross": MapNode(id: "hall_middle_cross", name: "Main Intersection", position: CGPoint(x: 0.50, y: 0.53), connectedEdges: ["hall_washroom", "hall_dr_2", "hall_elevator", "hall_dr_3"], isDestination: false),
        
        "hall_elevator": MapNode(id: "hall_elevator", name: "Hallway", position: CGPoint(x: 0.50, y: 0.63), connectedEdges: ["hall_middle_cross", "elevator", "lab_room", "hall_pharmacy"], isDestination: false),
        "hall_pharmacy": MapNode(id: "hall_pharmacy", name: "Hallway", position: CGPoint(x: 0.50, y: 0.73), connectedEdges: ["hall_elevator", "patient_info", "pharmacy", "hall_bottom_cross"], isDestination: false),
        "hall_bottom_cross": MapNode(id: "hall_bottom_cross", name: "Bottom Intersection", position: CGPoint(x: 0.50, y: 0.82), connectedEdges: ["hall_pharmacy", "hall_patient_restrooms"], isDestination: false),
